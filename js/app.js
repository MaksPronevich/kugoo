...
* Copyright (c) 2020 Apoorv Saxena; Licensed MIT */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-banner__slider")) new core(".main-banner__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        ...
                        document.querySelector(".slider-control__progress");
            ...
            if (document.querySelector(".video-reviews-block__slider")) new core(".video-reviews-block__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: false,
                navigation: {
                    prevEl: ".video-reviews-block__btn-prev",
                    nextEl: ".video-reviews-block__btn-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1.2,
            ...
            if (document.querySelector(".articles-block__slider")) new core(".articles-block__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                loop: false,
                navigation: {
                    prevEl: ".articles-block__btn-prev",
            ...
            if (document.querySelector(".team-block__slider")) new core(".team-block__slider", {
                ...
                loop: false,
                navigation: {
                    prevEl: ".team-block__btn-prev",
                    nextEl: ".team-block__btn-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1.2
            ...
            if (document.querySelector(".sertificate-slider")) new core(".sertificate-slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".sertificate-slider__btn-prev",
                    nextEl: ".sertificate-slider__btn-next"
                }
            });
            if (document.querySelector(".recommendations-block__slider")) new core(".recommendations-block__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: false,
                navigation: {
                    prevEl: ".recommendations-block__btn-prev",
                    nextEl: ".recommendations-block__btn-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1.1,
            ...
            if (document.querySelector(".media-product__slider2") && document.querySelector(".media-product__slider")) {
                const swiperMain = new core(".media-product__slider2", {
                    spaceBetween: 10,
                    slidesPerView: 10,
                    freeMode: true,
                    simulateTouch: true
                });
                new core(".media-product__slider", {
                    modules: [ Thumb ],
                    spaceBetween: 10,
                    thumbs: {
                        swiper: swiperMain
        ...
        const observer = lozad_min(".lozad", {});
        observer.observe();
        ...
        const buttonCatalog = document.querySelector(".button-catalog-header");
        const menuCatalogItems = document.querySelectorAll(".menu-header-catalog__link");
        const subMenuCatalogBlocks = document.querySelectorAll(".sub-menu-header-catalog__block");
        const links = document.querySelectorAll("._no-link");
        let showed;
        if (buttonCatalog) buttonCatalog.addEventListener("click", (() => {
            buttonCatalog.classList.toggle("button-catalog-header-active");
            catalog.classList.toggle("hidden");
        }));
        if (menuCatalogItems.length === subMenuCatalogBlocks.length) menuCatalogItems.forEach(((menuCatalogItem, index) => {
            menuCatalogItem.addEventListener("mouseover", (e => {
                const currentBlock = subMenuCatalogBlocks[index];
                menuCatalogItem.classList.remove("current");
                if (showed) showed.classList.remove("show");
                showed = currentBlock;
        ...
        window.addEventListener("click", (e => {
            const target = e.target;
            if (!catalog.classList.contains("hidden") && !target.closest(".header-catalog") && !target.closest(".button-catalog-header")) {
                catalog.classList.add("hidden");
                buttonCatalog.classList.remove("button-catalog-header-active");
            }
        }));
        const tipTrigger = document.querySelector(".tip__trigger");
        const tipContent = document.querySelector(".tip__content");
        if (tipTrigger && tipContent) tipTrigger.addEventListener("mouseover", (() => {
        ...
        if (btnToTop) window.addEventListener("scroll", (function() {
            btnToTop.classList.remove("show");
            if (pageYOffset >= 800) btnToTop.classList.add("show");
        }));
        window["FLS"] = false;
        isWebp();
        menuInit();
